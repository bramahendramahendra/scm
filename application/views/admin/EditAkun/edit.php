...
<div class="col-lg-5 col-lg-offset-2">
    ...
    <form action="" method="POST">
        <div class="form-group">
            ...
            <input class="form-control" name="name" placeholder="Enter Name" value="<?php echo $admin->name; ?>">
        </div>

        <div class="form-group">
            <label for="username">Username:</label>
            <input class="form-control" name="username"  placeholder="Enter Username" value="<?php echo $admin->username; ?> ">
        </div>
